...
A modern, elegant restaurant website featuring a celestial-inspired design with responsive layouts and interactive elements.
...
- HTML5
- CSS3 (CSS Flexbox, Grid, Custom Properties)
- Vanilla JavaScript
